...
document.querySelector('#interactive').innerHTML = `
  <div id="step1">
    <span>Do you have a legit base game installed?</span><br>
...
const newCheckbox = (name, value) => {
  if(value.match(/^[fegs]p\d{2}$/))
    name = `<code>[${value.toUpperCase()}]</code> ${name}`
